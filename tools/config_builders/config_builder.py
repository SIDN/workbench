...
class NSD4ConfigGenerator(ConfigGenerator):
    ...
    def get_start(self):
        return [
            ...
            "remote-control:",
            "        control-enable: yes",
            "        server-cert-file: \"/var/workbench/nsd4/etc/nsd/nsd_server.pem\"",
            "        control-cert-file: \"/var/workbench/nsd4/etc/nsd/nsd_control.pem\"",
            ""
        ]
    ...
    def get_update_lines(self):
        return [
            "/var/workbench/nsd4/sbin/nsd-control reload"
        ]
...
class YadifaConfigGenerator(ConfigGenerator):
    ...
    def get_start(self):
        return [
            ...
            "        daemon                      on",
            "        chroot                      off",
            "        logpath                     \"/var/workbench/yadifa/var/log\"",
            "        pidpath                     \"/var/workbench/yadifa/var/run\"",
            "        datapath                    \"/var/workbench/yadifa/var/zones\"",
            "        keyspath                    \"/var/workbench/yadifa/var/zones/keys\"",
            "        xfrpath                     \"/var/workbench/yadifa/var/zones/xfr\"",
            "        version                     \"1.0.3\"",
            "",
            "        edns0-max-size              4096",
            "        max-tcp-queries             100",
